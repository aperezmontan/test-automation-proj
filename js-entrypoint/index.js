...
const firstFileNameWithPath = createFileNameWithPath({
  fileName: firstFileName || "Store1.csv",
});
const secondFileNameWithPath = createFileNameWithPath({
  fileName: secondFileName || "Store2.csv",
});
const saveToFileWithPath =
  saveToFile && createFileNameWithPath({ fileName: saveToFile });

compareCustomers({
  firstFileName: firstFileNameWithPath,
  secondFileName: secondFileNameWithPath,
})
  .then((res) => {
